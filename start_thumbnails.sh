...
docker run --name deepdream-compute --label deepdream -v //c/Users/slant/clouddream/deepdream:/opt/deepdream -d   visionai/clouddream bash -c "cd /opt/deepdream && ./process_thumbnail_images.sh 2>&1 > log.html"
